<aside class="col-md-3">
    ...
    <div class="list-group mb-3 mb-lg-0">
        <a class="list-group-item list-group-item-action {{ request()->is('encomenda*') ? 'active' : '' }}" href="{{ route('cliente.encomendas') }}"> <i class="fas fa-shopping-bag pr-3"></i>Encomendas </a>
        ...
        <a class="list-group-item list-group-item-action {{ request()->is('cliente/e*') ? 'active' : '' }}" href="{{ route('estampas.cliente') }}"> <i class="far fa-tshirt pr-3"></i>Minhas Estampas </a>
